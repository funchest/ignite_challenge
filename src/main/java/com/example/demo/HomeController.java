...
public class HomeController {
    ...
    public ModelAndView add(@RequestParam String isbn, @RequestParam String author,@RequestParam String title) throws ClassNotFoundException, SQLException {
        ...
        if(isbn!=""&&author!=""&&title!=""&&!ifEntryExists(isbn)) {
            ...
            //st.execute("INSERT INTO BOOK VALUES ('" + isbn + "','" + author + "','" + c + "','" + title + "')");
    ...
    public ModelAndView deletebook(@RequestParam String isbn) throws SQLException, ClassNotFoundException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:h2:mem:navin","sa","");
        Statement st=conn.createStatement();
        //st.execute("DELETE FROM BOOK WHERE ISBN='" + isbn+"'");
    ...
    public ModelAndView edit(@RequestParam String oldISBN, @RequestParam String ISBN,@RequestParam String newauthor,@RequestParam String newtitle) throws SQLException, ClassNotFoundException {
        ...
        if(ifEntryExists(oldISBN)) {
            ...
            */
                ...
                if (!ISBN.equals("")) {
                    //update INSB in comments
                   // st.execute("UPDATE COMMENT SET ISBN='" + ISBN + "' WHERE ISBN='" + oldISBN + "'");
            ...
            if (!ISBN.equals("") && !newauthor.equals("") && !newtitle.equals("")) {
                //st.execute("UPDATE BOOK SET ISBN='" + ISBN + "', AUTHOR='" + newauthor + "', COMMENTS ='" + c + "', TITLE='" + newtitle + "' WHERE ISBN='" + oldISBN + "'");
                ...
                //st.execute("UPDATE BOOK SET ISBN='" + ISBN + "', AUTHOR='" + newauthor + "', COMMENTS ='" + c + "' WHERE ISBN='" + oldISBN + "'");
               ...
               // st.execute("UPDATE BOOK SET ISBN='" + ISBN + "' WHERE ISBN='" + oldISBN + "'");
               ...
               // st.execute("UPDATE BOOK SET ISBN='" + ISBN + "', COMMENTS ='" + c + "', TITLE='" + newtitle + "' WHERE ISBN='" + oldISBN + "'");
                ...
                //st.execute("UPDATE BOOK SET AUTHOR='" + newauthor + "', COMMENTS ='" + c + "' WHERE ISBN='" + oldISBN + "'");
               ...
               // st.execute("UPDATE BOOK SET COMMENTS ='" + c + "', TITLE='" + newtitle + "' WHERE ISBN='" + oldISBN + "'");
               ...
               // st.execute("UPDATE BOOK SET AUTHOR='" + newauthor + "', COMMENTS ='" + c + "', TITLE='" + newtitle + "' WHERE ISBN='" + oldISBN + "'");
